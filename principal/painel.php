...
<head>
    ...
    <title>Page Academia - VideoAula</title>
</head>

<body>
    <header>
        <div class="menu-content">
            <h1 class="logo"> AcademiaInfinity</h1 href="http://127.0.0.1:5500/index.html#">
    ...
    <main>
        <div class="main-content">
            ...
            <div class="btns">
                ...
                <button class="btn-personal">Contatar personal Trainer</button>
            </div>
        </div>
    </main>
